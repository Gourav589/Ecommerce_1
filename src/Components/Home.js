    ...
    <ul>
      <li>
        ...
        <ul className="dropdown-menu">
          <li>
            <a href="#">Bajaj Almond Hair</a>
          </li>
          <li>
            <a href="#"> Toothpaste 150 g</a>
          </li>
          <li>
            <a href="#">Mustard Oil</a>
          </li>
          <li>
            <a href="#"> Amul Butter</a>
          </li>
          <li>
            <a href="#">Red Label Tea</a>
          </li>
          <li>
            <a href="#"> Saffola Masala Oats</a>
          </li>
          <li>
            <a href="#">Dabur Honey</a>
          </li>
          <li>
            <a href="#">Syrup Chocolate</a>
          </li>
        </ul>
      </li>
    </ul>
